...
PARENT_DIR = r"//ads.warwick.ac.uk/shared/HCSS6/Shared305/Microscopy/Jeffrey-Ede/models/wavefunctions/output_2nd_val/"
SAVE_DIR = r"F:/wavefunctions_unseen_train_refined/"
...
for i, dir in enumerate(example_dirs):
    ...
    save_filepath = SAVE_DIR + f"wavefunctions/{i}.npy"

    copyfile(dir+"Diff.json", SAVE_DIR + f"meta/{i}-{cif_num}.json")
