...
PARENT_DIR = r"F:\wavefunctions_refined\wavefunctions\\"

TRAIN_DIR = r"H:\wavefunctions_refined\train\\"
VAL_DIR = r"H:\wavefunctions_refined\val\\"
TEST_DIR = r"H:\wavefunctions_refined\test\\"

#Get CIF-wavefunction pairs
cif_wave = os.listdir(r"F:\wavefunctions_refined\meta\\")
