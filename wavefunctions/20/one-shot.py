...
def configure(
  ...
  if adversarial:
      ...
      if use_gradient_penalty:
          ...
          discr_batch = tf.concat([output, inputs*target_outputs, x_hat], axis=0)
      else:
          discr_batch = tf.concat([output, inputs*target_outputs], axis=0)
...
def experiment(report_every_n=100):
  ...
  start_iter = 0#109_287#98_689#177_312#98_689#94_863#0
  train_iters = 500_000
  val_iters = 1_000
