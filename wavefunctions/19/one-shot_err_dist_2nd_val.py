...
def load_data(dir, subset, batch_size):
    ...
    with tf.device('/cpu:0'):
        ...
        dataset = tf.data.Dataset.list_files(dir+"*.npy")
...
def experiment(report_every_n=100):
  ...
  data_dir = "//Desktop-sa1evjv/f/wavefunctions_unseen_train/wavefunctions/"
  batch_size = 24
    ...
    for iter in range(start_iter, train_iters):
      ...
      if iter < 20000//batch_size:
        ...
        if not iter % (1000//batch_size):
            ...
            np.save(model_dir+"2nd_val_err.npy", errors0)
