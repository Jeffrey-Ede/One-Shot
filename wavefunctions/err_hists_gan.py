...
model_dir = "Z:/Jeffrey-Ede/models/wavefunctions/37/"
...
for i, (data_nums, labels) in enumerate(zip(sets, labels_sets)):
    ...
    plt.legend(loc='upper right', frameon=True, fontsize=8, facecolor='white', 
               framealpha=0., edgecolor="white", bbox_to_anchor=(.98,.98))

    plt.axvline(x=0.75, color='black', linestyle='--', linewidth=0.6)

    save_loc =  model_dir + "hist_gan.png"
