...
EXE_DIR = r"\\flexo.ads.warwick.ac.uk\shared41\Microscopy\Jeffrey-Ede\models\wavefunctions\clTEM_file_0.2.4"
exe_filepath = os.path.join(EXE_DIR, "clTEM_cmd.exe")

OUTPUT_DIR = os.path.join(PARENT_DIR, "output_single_refined")
if not os.path.exists(OUTPUT_DIR):
    os.makedirs(OUTPUT_DIR)

NUM_REPEATS = 5000

CONFIG_DIR = os.path.join(PARENT_DIR, "temp_single_refined")
config_filepath = os.path.join(CONFIG_DIR, "current_config_single_refined.json")
