...
def configure(
  ...
  error_dist = tf.reduce_mean( tf.abs(output - target_outputs), axis=[1,2,3] )

  return train_op, output_loss, output, error_dist
