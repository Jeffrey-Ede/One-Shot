...
OUTPUT_DIR = os.path.join(PARENT_DIR, "output_2nd_val_refined")
if not os.path.exists(OUTPUT_DIR):
    os.makedirs(OUTPUT_DIR)

NUM_REPEATS = 3

CONFIG_DIR = os.path.join(PARENT_DIR, "temp_jmede_2nd_val_refined")
config_filepath = os.path.join(CONFIG_DIR, "current_config_2nd_val_refined.json")
