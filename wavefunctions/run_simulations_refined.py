...
# V:\Microscopy\Jeffrey-Ede\models\wavefunctions
...
OUTPUT_DIR = os.path.join(PARENT_DIR, "output_refined")
if not os.path.exists(OUTPUT_DIR):
    os.makedirs(OUTPUT_DIR)

NUM_REPEATS = 3

CONFIG_DIR = os.path.join(PARENT_DIR, "temp_refined")
config_filepath = os.path.join(CONFIG_DIR, "current_config_refined.json")
...
def do_sim(cif_filepath):
    ...
    for out_path in out_paths:
        ...
        if zone_h == 0 and zone_k == 0 and zone_l == 0:
            zone_h = 0
